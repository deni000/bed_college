    ...
    <div class="row">
      <div class="col-md-8">
        <ul class="list-inline custom-breadcrumb mb-2">
          ...
          <li class="list-inline-item text-white h3 font-secondary nasted">Governing Body</li>
        </ul>
      </div>
    </div>
  </div>
...
<section class="section">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <h2 class="section-title">GOVERNING BODY :</h2><br>
        <div class="myDiv">
        	<img src="images/govern.jpg" class="responsive" width="600" height="400">
	      </div>
       </div>
      </div>
    </div>
